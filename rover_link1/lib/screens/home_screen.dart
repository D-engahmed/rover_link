...
class _HomeScreenState extends State<HomeScreen> {
      ...
      body: SafeArea(child: Column(children: [
        ...
        Expanded(child: SingleChildScrollView(padding: const EdgeInsets.all(16), child: Column(children: [
          ...
          SizedBox(width: double.infinity, height: 54, child: ElevatedButton.icon(
            ...
            onPressed: () {}, icon: const Icon(Icons.stop_circle_outlined), label: const Text('EMERGENCY STOP'),
          )),
        ]))),
      ])),
  ...
  Widget _header(bool connected) => Container(
    ...
    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      Text(connected ? 'ONLINE' : 'OFFLINE', style: TextStyle(color: connected ? RoverColors.radarGreen : RoverColors.textMuted, fontSize: 10, fontWeight: FontWeight.bold)),
    ]),
  );
